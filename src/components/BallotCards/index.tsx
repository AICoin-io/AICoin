...
const BallotCards: NextPage = () => {
  const BALLOT_FACTORY_CONTRACT = "0x85bCf677871c249B717FfF70d07aCE504207CFF4";
  ...
  return (
    <Stack alignItems="center">
      ...
      <Grid
        templateColumns={
          data.ballots.length < 2 ? "repeat(1, 4fr)" : "repeat(2, 4fr)"
        }
        gap={8}
        maxWidth="60%"
        pt={10}
      ...
      >
        {data.ballots.map((value: any, i: any) => {
          if (value.isSealed == true && value.isClosed == false) {
            return (
